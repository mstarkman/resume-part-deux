const experiences = [
  {
    ...
    location: "Remote",
    bullets: [
      "Automated the generation of our Amazon AMI’s that are used to deploy our application to AWS Elastic Beanstalk.  This was done to ensure that we kept our servers up to date for SOC2 compliance.",
